                ...
                <div className="flex justify-between items-center">
                    ...
                    <div className="hidden md:block">
                        <div className="ml-10 flex items-baseline space-x-6">
                            ...
                            <Link
                                href="#contacto"
                                className="bg-indigo-600 hover:bg-indigo-700 text-white px-5 py-2 rounded-full text-xs font-bold transition-all transform hover:scale-105"
                            >
                                {t('cta')}
                            </Link>
                        </div>
                        ...
                        <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3 border-t border-gray-800">
                            ...
                            <div className="pt-4 pb-2 px-3">
                                <Link
                                    href="#contacto"
                                    onClick={() => setIsOpen(false)}
                                    className="w-full bg-indigo-600 hover:bg-indigo-700 text-white block text-center px-4 py-3 rounded-xl text-base font-bold"
                                >
                                    {t('cta')}
                                </Link>
                            </div>
