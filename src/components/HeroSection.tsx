                    ...
                    >
                        <div className="flex flex-col items-center lg:items-start">
                            <div className="flex w-full justify-start lg:justify-start">
                                <div className="inline-flex items-center space-x-2 bg-indigo-500/10 border border-indigo-500/20 rounded-full px-3.5 py-1.5 mb-6">
                                    <BoltIcon className="h-4 w-4 text-indigo-400" />
                                    <span className="text-indigo-300 text-[13px] font-medium tracking-wide text-left">
                                        {t('badge')}
                                    </span>
                                </div>
                            </div>

                            <h1 className="text-5xl md:text-7xl font-extrabold text-white leading-tight mb-6 text-center lg:text-left">
                                {t('titlePart1')} <span className="gradient-text">{t('titlePart2')}</span>
                            </h1>

                            <p className="text-xl text-gray-400 mb-8 max-w-lg leading-relaxed text-center md:text-left">
                                {t('description')}
                            </p>
                            ...
                            <div className="flex flex-col sm:flex-row space-y-4 sm:space-y-0 sm:space-x-4">
                                <Link
                                    href="#contacto"
                                    className="bg-indigo-600 hover:bg-indigo-700 text-white px-4 py-2 md:px-8 md:py-4 rounded-xl text-lg font-bold transition-all transform hover:scale-105 shadow-xl shadow-indigo-600/20 flex items-center justify-center space-x-2"
                                >
                                    <span>{t('cta')}</span>
