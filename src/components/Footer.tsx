                ...
                <div className="flex flex-col items-center justify-center py-12 gap-10 mb-12 border-b border-gray-800">
                    ...
                    <div className="flex flex-wrap justify-center gap-4">
                        {[
                            {
                                name: 'Instagram',
                                href: 'https://www.instagram.com/vitality.global.us/',
                                icon: (
                            ...
                            {
                                name: 'Facebook',
                                href: 'https://www.facebook.com/people/Vitality-Global/61585019354791/',
                                icon: (
                                    <svg className="w-6 h-6 fill-current" viewBox="0 0 24 24">
                            ...
                            {
                                name: 'TikTok',
                                href: 'https://www.tiktok.com/@vitalityglobal',
                                icon: (
                                    <svg className="w-6 h-6 fill-current" viewBox="0 0 24 24">
